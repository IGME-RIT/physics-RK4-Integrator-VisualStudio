...
void key_callback(GLFWwindow* window, int key, int scancode, int action, int mods)
{
	...
	//This set of controls are used to move one Timestep.
...
void main()
{
	...
	window = glfwCreateWindow(800, 800, "RK4 Integrator", nullptr, nullptr);
	std::cout << "\n This is a demonstration\/comparison of the two types of integrator.\n\n\n\n\n";
	std::cout << "Use \"Space\" to move ahead by 1 timestep. The red line is calculated using RK4 and the blue is done using euler integrator.";
